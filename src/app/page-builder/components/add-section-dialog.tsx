  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogPortal>
        ...
        <DialogContent className="fixed left-[50%] top-[50%] z-50 translate-x-[-50%] translate-y-[-50%] w-[95vw] min-w-6xl mt-8 max-w-6xl text-white h-[85vh] overflow-hidden backdrop-blur-2xl bg-slate-900/80 border border-white/20 shadow-2xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95">
          <DialogHeader>
