...
const SIZES: TitleSize[] = ['xs', 'sm', 'base', 'lg', 'xl', '2xl', '3xl', '4xl', '5xl', '6xl', '7xl', '8xl', '9xl'];
const PADDINGS: Record<TitlePadding, string> = {
  none: 'p-0',
  xs: 'p-2',
  sm: 'p-4',
  md: 'p-6',
...
const MutationTitle = ({ data, onSubmit }: TitleFormProps) => {
  const [formData, setFormData] = useState<ITitleData>({ ...defaultDataTitle });

  useEffect(() => {
    if (data) setFormData({ ...defaultDataTitle, ...data });
  }, [data]);
