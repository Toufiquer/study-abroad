...
and update-data.ts
```
import { defaultData as sectionData1, ISectionData as ISectionData1 } from '../../page-builder/all-section/section-1/data';
import { defaultData as sectionData2, ISectionData as ISectionData2 } from '../../page-builder/all-section/section-2/data';
import { defaultData as sectionData3, ISectionData as ISectionData3 } from '../../page-builder/all-section/section-3/data';
import { defaultData as sectionData4, ISectionData as ISectionData4 } from '../../page-builder/all-section/section-4/data';
import { defaultData as sectionData5, ISectionData as ISectionData5 } from '../../page-builder/all-section/section-5/data';
import { defaultData as sectionData6, ISectionData as ISectionData6 } from '../../page-builder/all-section/section-6/data';

export type SectioinDataType = ISectionData1 | ISectionData2 | ISectionData3 | ISectionData4 | ISectionData5 | ISectionData6;

export type defaltFullPageData = {
  pageTitle: string;
  pagePath: string;
  content: {
    isActive: boolean;
...
pageBuilderSchema = defaltFullPageData
sectionContentSchema = SectioinDataType

Now your task is rewrite controller.ts, model.ts, and route.ts if need.