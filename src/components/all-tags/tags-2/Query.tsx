...
import { defaultDataButton2, IButton2Data, Button2Props } from './data';
import { cn } from '@/lib/utils';

const QueryButton2 = ({ data }: Button2Props) => {
  let buttonData = defaultDataButton2;
