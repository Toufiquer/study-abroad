        ...
        <div className="p-8">
          <div className="flex flex-col md:flex-row items-start gap-6 mb-6">
            ...
            <div className="flex-1">
              <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-sky-300 to-blue-300 mb-3">{item.name}</h2>
      ...
      >
        <div className={`flex flex-col ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'} gap-0`}>
          ...
          <div className="relative z-10 w-full md:w-1/2 p-6 flex flex-col justify-center">
            <h3 className="text-3xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-sky-300 to-blue-200 mb-3">{item.name}</h3>
      ...
      <section className="relative z-10 mx-auto max-w-7xl">
        <div className={`text-center mb-12 transition-all ${scrolled ? 'opacity-90 scale-98' : 'opacity-100 scale-100'}`}>
          <div className="inline-block mb-4 px-6 py-2 rounded-full bg-sky-500/20 border-2 border-sky-400/40">
            <span className="text-sky-300 text-sm font-bold uppercase tracking-wider">Welcome to App Generator </span>
          </div>
          <h1 className="text-5xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-sky-300 via-blue-200 to-sky-300">About App Generator </h1>
        </div>
