...
import { defaultDataSlider, ISliderData, SliderProps } from './data';
import Image from 'next/image';

const QuerySlider = ({ data }: SliderProps) => {
  let sliderData = defaultDataSlider;
  ...
  // Calculate maximum index based on how many items show at once
  // e.g. 5 slides, 2 per slide.
  // Max valid index start point depends on infinite loop or not.
  // For simple infinite loop (reset to 0), we allow going up to slides.length - 1,
  // but visual might have empty space if not cloned.
  // For this implementation, we treat index as the starting item.
