...
```
  const aboutData = [
    ...
    },
    {
      ...
      icon: <BookOpen />,
      description:
        'We are a leading English  dedicated to providing high-quality language education. Our programs are designed for school students, professionals, and test-takers who wish to excel in IELTS, Spoken English, and academic English.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      icon: <Globe2 />,
      description:
        'Located at a convenient and accessible place, our  welcomes students and professionals. For inquiries or admissions, visit our contact page or reach out via phone or email.',
    },
  ];```