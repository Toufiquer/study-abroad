...
export default function TermsAndCondition() {
  ...
  const termsAndConditionsData: ITermsAndConditionsData[] = [
    ...
    },
    {
      ...
      childData: [
        ...
        },
        {
          ...
          icon: <ShieldCheck />,
          description: 'The  reserves the right to modify class schedules, instructors, or course content to maintain quality and relevance.',
        },
      ],
    },
    {
      ...
      icon: <ShieldCheck />,
      description:
        'Students are expected to maintain discipline, respect peers and instructors, and adhere to the rules of the . Misconduct may lead to suspension or termination of enrollment.',
    },
    {
      id: 5,
      ...
      icon: <BookOpen />,
      description:
        'All learning materials, videos, and course content are the property of the . Unauthorized copying, sharing, or reproduction is strictly prohibited.',
    },
    {
      id: 6,
      ...
      icon: <AlertTriangle />,
      description:
        'While we strive to provide the best learning experience, the  is not responsible for indirect or incidental losses arising from course participation or website usage.',
    },
    {
      id: 7,
    ...
    },
    {
      ...
      icon: <AlertTriangle />,
      description: 'The  reserves the right to terminate access to services for violations of these terms or inappropriate behavior without prior notice.',
    },
    {
      id: 9,
      name: 'Amendments',
