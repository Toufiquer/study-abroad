...
const defaultData: AboutItem[] = [
  {
    ...
    description:
      'At App Generator , our mission is to empower ambitious students across Bangladesh to achieve global academic success. We strive to provide world-class test preparation, scholarship guidance, and mentorship to help our students secure fully funded opportunities at top universities in the USA, UK, and Canada.',
  },
  {
    id: 2,
    name: 'About Our ',
  ...
  },
  {
    ...
    description:
      "With our proven success record and student-centered teaching approach, App Generator  is trusted by learners nationwide. We combine expert mentorship, modern online tools, and data-driven learning insights to maximize each student's success rate in both tests and scholarship applications.",
  },
  {
    id: 6,
    name: 'Our Approach',
  ...
  },
  {
    ...
    description:
      "App Generator  is based in Bangladesh and proudly serves students nationwide through our online learning platform. Whether you're in Dhaka, Chittagong, or anywhere else, our instructors and counselors are available online to guide you toward your study abroad dream.",
    childData: [
      {
        id: '7.1',
        name: 'Head Office',
...
export default function AboutAdminPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br p-8 text-white relative overflow-hidden">
      ...
      <h1 className="text-3xl md:text-4xl font-extrabold mb-10 text-center text-transparent bg-clip-text bg-linear-to-r from-sky-300 via-blue-300 to-sky-200 drop-shadow-lg">
