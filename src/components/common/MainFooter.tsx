    ...
    <footer className="relative mt-16 bg-gradient-to-br from-blue-100/40 via-purple-100/40 to-white/30 backdrop-blur-2xl border-t border-white/40 text-gray-700 overflow-hidden">
      ...
      >
        ...
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2">
              <Image src="https://i.ibb.co/pzsn8MG/english-logo.png" alt="English  Logo" width={40} height={40} className="rounded-lg shadow-sm" />
              <span className="text-xl font-semibold text-blue-700">English </span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              <li>📍 English , 2nd Floor, Green Plaza, Dhanmondi, Dhaka – 1209</li>
              <li>📞 +880 1700-123456</li>
              <li>✉️ info@english.com</li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs md:text-sm text-gray-600">
          <p>&copy; {new Date().getFullYear()} English . All rights reserved.</p>
