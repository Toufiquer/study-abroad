// ✅ Updated generate-add.tsx (With isPersonal logic)
interface Schema {
...
export const generatePersonalAddComponentFile = (inputJsonFile: string): string => {
...
import { ${reduxMutationHook} } from '${reduxPath}'
